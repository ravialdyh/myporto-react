        ...
        <CardContent className="p-4 sm:p-6 md:p-8 lg:p-10">
          <div className="space-y-8">
            ...
            <section className="space-y-4">
              ...
              <p className="text-sm sm:text-base">
                Now, let's define a random variable X that represents the outcome of the die roll:
              </p>
              <Card className="bg-muted p-4">
                <MathJax>
              ...
              <p className="text-sm sm:text-base">
                This is an example of an identity function, where the random variable X assigns to each outcome its face value.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 pl-4 text-sm sm:text-base">
                <li>
                  ...
                  countable values. Our die rolling example is a discrete
                  random variable.
                </li>
                <li>
            ...
            <section className="space-y-4">
              ...
              <p className="text-sm sm:text-base">
                This uniform distribution reflects the equal probability of rolling any number on a fair die.
              </p>
            </section>
            ...
            <section className="space-y-4">
              <h2 className="text-xl sm:text-2xl font-semibold">Interactive Dice Roll Experiment</h2>
              <p className="text-sm sm:text-base">
                Explore the concept of random variables with this interactive dice roll experiment. 
                You can change the function that maps the dice roll outcomes to different values, 
                demonstrating how various random variables can be defined on the same sample space.
              </p>
              <DiceRollExperiment />
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-sm sm:text-base">
                ...
                phenomena. The interactive dice roll experiment above demonstrates 
                how we can define different random variables on the same sample space, 
                allowing us to model various aspects of an experiment or process.
              </p>
            </section>
          </div>
        </CardContent>
